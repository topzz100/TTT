...
const Contact = () => {
  return (
    <div className='bg-[rgb(10,38,64)] mx-[150px] rounded-xl my-16 relative z-10'>
        <img src="/images/ellipse-1.png" alt="" className='absolute top-0 right-0 -z-10' />
        <div className='p-16'>
            <h3 className='text-5xl font-normal text-white text-center w-[65%] leading-[72px]  mx-auto manrope'>An enterprise template to ramp up your company website</h3>
